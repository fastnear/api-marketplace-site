  ...
  theme: {
  	extend: {
  		...
  		keyframes: {
  			...
  			glow: {
  				'0%': {
  					boxShadow: '1px 6px 3px rgba(255, 255, 255, 0.3)'
  				},
  				'50%': {
  					boxShadow: '0 6px 3px rgba(255, 255, 137, 0.2)'
  				},
  				'100%': {
  					boxShadow: '1px 6px 3px rgba(255, 255, 137, 0.3)'
  				}
  			},
  			shimmerLight: {
  				'0%': {
  			...
  			shimmerDark: {
  				...
  				'50%': {
  					textShadow: '1px 2px 3px rgba(255, 255, 255, 0.4)'
  				},
  				'100%': {
  					textShadow: '0px 1px 3px rgba(255, 255, 255, 0.3)'
  				}
